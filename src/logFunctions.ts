...
const vscodeChannel: any = vscode.window.createOutputChannel(
  "QB64PE: .vscode",
  "QB64PE"
);
const completionChannel: any = vscode.window.createOutputChannel(
  "QB64PE: Completion",
  "QB64PE"
);
const createBackupChannel: any = vscode.window.createOutputChannel(
  "QB64PE: Create Backup",
  "QB64PE"
);
const decorateChannel: any = vscode.window.createOutputChannel(
  "QB64PE: Decorate",
  "QB64PE"
);
const definitionProviderChannel: any = vscode.window.createOutputChannel(
  "QB64PE: Definition Provider",
  "QB64PE"
);
...
const gitChannel: any = vscode.window.createOutputChannel(
  "QB64PE: Git",
  "QB64PE"
);
const helpChannel: any = vscode.window.createOutputChannel(
  "QB64PE: Help",
  "QB64PE"
);
const hoverProviderChannel: any = vscode.window.createOutputChannel(
  "QB64PE: Hover Provider",
  "QB64PE"
);
const inlineCompletionChannel: any = vscode.window.createOutputChannel(
  "QB64PE: Inline Completion",
  "QB64PE"
);
const lintChannel: any = vscode.window.createOutputChannel(
  "QB64PE: Lint",
  "QB64PE"
);
const referenceProviderChannel: any = vscode.window.createOutputChannel(
  "QB64PE: Reference Provider",
  "QB64PE"
);
const openIncludeFileChannel: any = vscode.window.createOutputChannel(
  "QB64PE: Open Include File",
  "QB64PE"
);
const openInQB64Channel: any = vscode.window.createOutputChannel(
  "QB64PE: Open In QB64PE",
  "QB64PE"
);
const scriptChannel: any = vscode.window.createOutputChannel(
  "QB64PE: Script",
  "QB64PE"
);
